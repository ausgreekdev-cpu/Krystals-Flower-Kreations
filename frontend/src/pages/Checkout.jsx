...
export default function Checkout(){
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <p className="text-sm text-muted mt-2">GST inclusive • Perth metro (12) / WA regional (18) / national (22) • free over $150 • Manual payments (Stripe paused) • Click & collect Perth</p>
      <form className="mt-6 grid gap-4 bg-surface2 p-6 rounded-2xl border" onSubmit={submit}>
        ...
        {loyalty && <div className="bg-surface border border-bloom-100 rounded-xl p-3 flex justify-between items-center">
          ...
          <div className="flex gap-2 items-center">
            ...
            }} className="bg-surface2 border rounded-full px-3 py-1 text-xs font-bold hover:bg-surface3">Redeem 100= $5</button>
          </div>
        </div>}
