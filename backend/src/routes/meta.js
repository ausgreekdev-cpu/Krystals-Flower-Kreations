...
router.get('/status', requireAuth, requireRole('admin','developer'), asyncHandler(async (req, res) => {
...
router.post('/sync/:productId', requireAuth, requireRole('admin','developer','maker'), asyncHandler(async (req, res) => {
